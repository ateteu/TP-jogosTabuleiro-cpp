...
public:
     ...
     * Inicializa a estrutura de estatísticas e carrega os dados do arquivo, se existente.
     */
    Score();
     ...
     * @param jogo Nome do jogo (e.g., "reversi", "lig4").
    ...
    /**
     * @brief Carrega as estatísticas do arquivo score.txt, se existir.
     */
    void carregar();
